...
ResumeBuilder is a powerful open-source resume builder and resume parser.
...
1. Download the repo `git clone https://github.com/devildev-cyber/resume-builder.git`
2. Change the directory `cd resume-builder`
...
1. Download the repo `git clone https://github.com/devildev-cyber/resume-builder.git`
2. Change the directory `cd resume-builder`
3. Build the container `docker build -t resume-builder .`
4. Start the container `docker run -p 3000:3000 resume-builder`
5. Open your browser and visit [http://localhost:3000](http://localhost:3000) to see ResumeBuilder live
